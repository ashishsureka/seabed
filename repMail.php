...
$subject = 'SEABED Case #'.$id.' Report Acknowledgement';
...
$message .='<p>Thanks for submitting the Report for the following case to SEABED. We appreciate your valuable contributions to SEABED. </p>';
 ...
 <col width="200">
  <col width="200">
   ...
   <tr>
    ...
    <td><a href="http://seabed.in/'.$rep.'">'.$repFile_name.'</a></td>
    </tr>
